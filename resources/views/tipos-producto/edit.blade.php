...
<head>
    ...
    <title>Editar Tipo de Producto - Dulcería</title>
    <style>
...
<body>
    ...
    <div class="container">
        <div class="form-container">
            ...
            <form method="POST" action="{{ route('tipos-producto.update', $tiposProducto) }}">
                @csrf
                @method('PUT')
                
                <div class="form-group">
                    <label for="nombre">Nombre</label>
                    <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $tiposProducto->nombre) }}" required>
                    @error('nombre')
                ...
                <div class="form-group">
                    ...
                    <textarea name="descripcion" id="descripcion">{{ old('descripcion', $tiposProducto->descripcion) }}</textarea>
                    @error('descripcion')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>
